#!/usr/bin/env python3
"""Quick test of preferred and staged semantics"""
import subprocess
import sys
...
# Test cases
tests = [
    ('preferred', 'grounded_subset_complete.lp'),
    ('preferred', 'semistable_preferred_asym.lp'),
    ('preferred', 'preferred_subset_complete.lp'),
    ('staged', 'stable_staged_3cycle.lp'),
    ('staged', 'staged_subset_cf.lp'),
]
