#!/usr/bin/env python3
"""
Comprehensive test: grounded semantics enumeration vs optN consistency
...
def run_grounded(framework, use_optN=False, timeout=30):
...
def test_framework(framework, timeout=30):
    ...
    enum_exts, enum_err = run_grounded(framework, use_optN=False, timeout=timeout)
    optN_exts, optN_err = run_grounded(framework, use_optN=True, timeout=timeout)
...
def main():
    print("=" * 80)
    print("Grounded Semantics Consistency Test: Enumeration vs OptN")
    print("=" * 80)
